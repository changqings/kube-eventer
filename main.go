...
import (
	...
	"github.com/changqings/kube-eventer/api"
...
func main() {
	...
	flag.StringVar(&argKubeCluster, "kube-cluster", "default", "kube cluster name")
	flag.Parse()
	...
	// sinks
	sinksFactory := sinks.NewSinkFactory(argKubeCluster)
